...
public class StatsServiceTest {
    ...
    public void shouldFindMaxSalesMonth () {
        ...
        int expected = 8;
        int actual = service.maxSaleMonth(array);
    ...
    public void shouldFindMinSalesMonth () {
        ...
        int expected = 9;
        int actual = service.minSaleMonth(array);
    ...
    public void shouldFindBelowAverageSalesMonths () {
        ...
        int expected = 5;
        int actual = service.belowAverageYearSales(array);
    ...
    public void shouldFindAboveAverageSalesMonths () {
        ...
        int expected = 5;
        int actual = service.aboveAverageYearSales(array);
